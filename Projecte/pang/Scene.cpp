...
void Scene::render()
{
	...
	if (vidas >= 0 && !changeStage) {
		...
		if(level < 17) textRenderer.render(timeText, glm::vec2(round(11.3f/16.0f*currentWidth), round(1.0f/9.0f*currentHeight)), round(currentWidth / 40), glm::vec4(1, 1, 1, 1));
		else textRenderer.render(timeText, glm::vec2(round(11.3f / 16.0f * currentWidth), round(1.0f / 9.0f * currentHeight)), round(currentWidth / 40), glm::vec4(0.9, 0.9, 0.4, 1));
